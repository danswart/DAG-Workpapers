...
complex_dag_viz <-grViz("
  digraph DAG {
    ...
    X [label=\"X (Exposure)\", pos=\"1.0, 2.5!\", fontcolor=\"dodgerblue\"]
    Y [label=\"Y (Outcome)\", pos=\"4.0, 2.5!\", fontcolor=\"dodgerblue\"]
    Z [label=\"Z (Confounder)\", pos=\"2.5, 4.0!\", fontcolor=\"red\"]
    C [label=\"C (Confounder)\", pos=\"2.5, 1.0!\", fontcolor=\"orange\"]
    A [label=\"A\", pos=\"1.0, 4.0!\", fontcolor=\"purple\"]
    B [label=\"B\", pos=\"4.0, 4.0!\", fontcolor=\"green\"]
