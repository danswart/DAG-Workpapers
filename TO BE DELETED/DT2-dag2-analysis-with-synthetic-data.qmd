...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, 
                 fig.width = 8, fig.height = 5, out.width = "100%", fig.align = "center")
...
DT::datatable(head(dag_data),
              ...
              class = 'cell-border stripe compact responsive',  # Add responsive class
              rownames = FALSE,
              width = "100%")
...
```{r counterfactual-analysis, out.width="100%"}
...
```{r counterfactual-multiple-z, out.width="100%"}
